...
from PuzzleSolver.Puzzles.Futoshiki.FutoshikiSolver import FutoshikiSolver
...
class FutoshikiSolverTests(TestCase):
    ...
    def test_solution_5x5(self):
        ...
        higher_positions = [
            (Position(0, 0), Position(0, 1)), Position((0, 3), Position(0, 2)), Position((0, 3), Position(1, 3)), Position((0, 4), Position(0, 3)), Position((2, 0), Position(2, 1)), Position((2, 2), Position(1, 2)),
    ...
    def test_solution_7x7(self):
        ...
        higher_positions = [
            (Position(0, 0), Position(1, 0)), Position((0, 1), Position(0, 0)), Position((0, 4), Position(0, 5)), Position((0, 5), Position(0, 6)), Position((1, 1), Position(1, 0)), Position((1, 4), Position(1, 5)),
            ...
            (Position(3, 2), Position(2, 2)), Position((3, 3), Position(3, 2)), Position((3, 4), Position(3, 3)), Position((3, 6), Position(3, 5)), Position((4, 2), Position(4, 3)), Position((4, 3), Position(3, 3)),
    ...
    def test_solution_9x9(self):
        ...
        higher_positions = [
            (Position(0, 2), Position(0, 3)), Position((0, 3), Position(1, 3)), Position((0, 8), Position(1, 8)), Position((1, 0), Position(1, 1)), Position((1, 4), Position(0, 4)), Position((1, 7), Position(1, 6)),
            ...
            (Position(3, 5), Position(3, 6)), Position((3, 6), Position(4, 6)), Position((3, 7), Position(3, 6)), Position((4, 2), Position(4, 1)), Position((4, 7), Position(3, 7)), Position((5, 0), Position(5, 1)),
    ...
    def test_solution_11x11(self):
        grid = Grid([
            [7, 4, 10, _, _, _, _, _, _, _, _],
            [_, _, _, _, _, _, _, _, _, _, 11],
            [_, _, 5, _, _, _, 11, _, _, _, _],
            [_, _, _, _, _, _, _, _, _, _, _],
            [_, _, _, _, _, _, _, 7, _, _, _],
            [_, _, _, _, 5, _, _, 9, _, _, 3],
            [_, _, _, _, _, _, _, _, _, _, _],
            [_, _, _, _, _, _, 3, _, _, _, _],
            [_, 11, _, _, _, _, _, _, _, _, _],
            [_, _, _, _, _, _, 8, _, _, _, _],
            [_, _, _, _, _, _, _, _, _, _, 7]
        ])
        higher_positions = [
            (Position(0, 4), Position(1, 4)), Position((0, 5), Position(1, 5)), Position((0, 6), Position(0, 7)), Position((0, 7), Position(0, 8)), Position((0, 7), Position(1, 7)), Position((0, 9), Position(1, 9)),
            ...
            (Position(2, 2), Position(1, 2)), Position((2, 4), Position(3, 4)), Position((2, 9), Position(2, 8)), Position((3, 3), Position(3, 2)), Position((3, 4), Position(3, 5)), Position((3, 5), Position(4, 5)),
            Position((3, 6), Position(3, 7)),
            ...
            (Position(5, 3), Position(5, 4)), Position((5, 4), Position(6, 4)), Position((5, 7), Position(5, 8)), Position((5, 8), Position(4, 8)), Position((5, 9), Position(5, 10)), Position((6, 0), Position(5, 0)),
            ...
            (Position(7, 0), Position(6, 0)), Position((7, 1), Position(7, 0)), Position((7, 2), Position(8, 2)), Position((7, 6), Position(8, 6)), Position((7, 7), Position(7, 8)), Position((7, 7), Position(6, 7)),
            Position((7, 9), Position(7, 8)),
            ...
            (Position(9, 0), Position(8, 0)), Position((9, 1), Position(9, 0)), Position((9, 2), Position(10, 2)), Position((9, 3), Position(8, 3)), Position((9, 3), Position(10, 3)), Position((9, 4), Position(9, 3)),
            Position((9, 7), Position(10, 7)),
    ...
    def test_solution_13x13(self):
        grid = Grid([
            ...
            [_, 6, _, _, _, _, _, _, _, _, _, _, _, _, _],
            [_, 12, _, _, _, _, 1, _, 14, _, 8, _, _, _, _],
            [_, _, _, _, _, 13, _, _, _, _, 7, _, 4, _, _],
            [_, _, _, _, _, _, _, _, _, _, _, _, 8, _, _],
            [_, _, _, _, _, _, _, 15, 3, _, _, _, _, _, _],
            [_, _, 12, _, _, _, _, _, 6, _, _, _, _, _, _],
            [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
            [_, _, _, _, _, _, _, _, _, 11, _, _, 10, _, _],
            [_, _, _, _, _, _, _, _, _, _, _, _, 9, _, _],
            [_, 11, _, _, 1, _, _, _, _, _, _, _, _, _, 5],
            [_, _, _, _, _, _, _, _, _, _, _, 12, _, _, _],
            [7, 13, _, _, _, _, _, _, _, _, _, _, _, 8, _],
            [_, _, _, 11, 4, 3, 13, _, _, 9, 2, _, _, 10, 15]
        ])
        higher_positions = [
            (Position(0, 3), Position(0, 4)), Position((0, 8), Position(0, 7)), Position((0, 9), Position(0, 10)), Position((0, 10), Position(0, 11)), Position((1, 0), Position(1, 1)), Position((1, 1), Position(2, 1)),
            ...
            (Position(1, 9), Position(1, 8)), Position((1, 10), Position(1, 11)), Position((1, 12), Position(1, 11)), Position((1, 13), Position(1, 14)), Position((1, 14), Position(2, 14)), Position((2, 0), Position(2, 1)),
            ...
            (Position(2, 10), Position(3, 10)), Position((2, 12), Position(2, 13)), Position((2, 13), Position(1, 13)), Position((2, 14), Position(3, 14)), Position((3, 3), Position(3, 2)), Position((3, 4), Position(3, 3)),
            ...
            (Position(4, 3), Position(4, 2)), Position((4, 4), Position(4, 3)), Position((4, 9), Position(4, 10)), Position((4, 11), Position(5, 11)), Position((4, 13), Position(4, 12)), Position((4, 14), Position(5, 14)),
            ...
            (Position(5, 10), Position(6, 10)), Position((5, 11), Position(5, 12)), Position((5, 14), Position(5, 13)), Position((6, 1), Position(7, 1)), Position((6, 2), Position(6, 3)), Position((6, 3), Position(7, 3)),
            Position((6, 4), Position(6, 3)),
            ...
            (Position(7, 1), Position(8, 1)), Position((7, 4), Position(8, 4)), Position((7, 5), Position(7, 4)), Position((7, 6), Position(7, 5)), Position((7, 11), Position(7, 12)), Position((8, 0), Position(7, 0)),
            Position((8, 2), Position(8, 1)),
            ...
            (Position(8, 12), Position(7, 12)), Position((8, 13), Position(7, 13)), Position((8, 14), Position(8, 13)), Position((9, 1), Position(9, 2)), Position((9, 1), Position(8, 1)), Position((9, 3), Position(8, 3)),
            Position((9, 6), Position(9, 5)),
            ...
            (Position(9, 13), Position(9, 12)), Position((10, 1), Position(9, 1)), Position((10, 3), Position(9, 3)), Position((10, 5), Position(11, 5)), Position((10, 6), Position(9, 6)), Position((10, 8), Position(10, 7)),
            ...
            (Position(11, 11), Position(10, 11)), Position((11, 12), Position(12, 12)), Position((11, 13), Position(11, 12)), Position((11, 14), Position(11, 13)), Position((12, 0), Position(11, 0)),
            Position((12, 2), Position(12, 1)),
            ...
            (Position(13, 3), Position(12, 3)), Position((13, 4), Position(13, 3)), Position((13, 5), Position(14, 5)), Position((13, 6), Position(13, 7)), Position((13, 7), Position(14, 7)), Position((13, 8), Position(13, 7)),
            Position((13, 10), Position(14, 10)),
    ...
    def test_solution_13x13_2(self):
        grid = Grid([
            ...
            [_, _, 7, _, _, _, _, _, _, _, 3, _, _],
            [_, _, _, _, _, _, _, _, _, _, _, _, _],
            [_, _, _, _, _, _, _, _, _, _, _, _, _],
            [_, _, _, _, _, _, _, _, _, _, _, _, _],
            [_, _, 3, _, 11, _, _, _, _, 5, _, _, _],
            [_, _, _, _, _, _, 5, _, _, _, _, _, _],
            [_, 9, _, _, _, _, 3, _, _, _, 5, _, _],
            [_, _, _, _, _, _, _, _, 7, _, _, _, _],
            [_, 10, _, _, _, _, _, _, _, _, _, _, _],
            [_, _, _, 6, _, 12, _, _, _, _, 1, _, _],
            [_, _, _, 8, _, _, _, _, _, _, _, _, 5],
            [_, 8, _, 10, _, _, _, _, _, _, _, _, _]
        ])
        higher_positions = [
            (Position(0, 1), Position(0, 0)), (Position(0, 2), Position(0, 3)), (Position(0, 4), Position(0, 3)), (Position(0, 6), Position(1, 6)), (Position(0, 7), Position(0, 6)),
            (Position(0, 8), Position(0, 7)), (Position(0, 10), Position(0, 11)),
            (Position(0, 11), Position(0, 12)), (Position(1, 1), Position(1, 2)), (Position(1, 2), Position(0, 2)), (Position(1, 4), Position(0, 4)), (Position(1, 5), Position(2, 5)),
            (Position(1, 6), Position(1, 5)), (Position(1, 7), Position(1, 8)),
            (Position(1, 8), Position(0, 8)), (Position(1, 9), Position(1, 10)), (Position(1, 11), Position(1, 10)), (Position(1, 12), Position(1, 11)), (Position(2, 0), Position(2, 1)),
            (Position(2, 2), Position(2, 3)), (Position(2, 3), Position(3, 3)),
            (Position(2, 4), Position(3, 4)), (Position(2, 6), Position(2, 7)), (Position(2, 7), Position(3, 7)), (Position(2, 9), Position(3, 9)), (Position(2, 10), Position(1, 10)),
            (Position(2, 11), Position(2, 10)),
            (Position(2, 11), Position(2, 12)),
            (Position(2, 12), Position(3, 12)), (Position(3, 0), Position(2, 0)), (Position(3, 0), Position(4, 0)), (Position(3, 1), Position(4, 1)), (Position(3, 2), Position(2, 2)),
            (Position(3, 3), Position(4, 3)), (Position(3, 6), Position(3, 5)),
            (Position(3, 6), Position(4, 6)), (Position(3, 9), Position(3, 8)), (Position(3, 10), Position(3, 11)), (Position(3, 11), Position(2, 11)), (Position(4, 0), Position(5, 0)),
            (Position(4, 2), Position(5, 2)), (Position(4, 4), Position(3, 4)),
            (Position(4, 6), Position(4, 7)), (Position(4, 7), Position(3, 7)), (Position(4, 8), Position(5, 8)), (Position(4, 9), Position(4, 8)), (Position(4, 11), Position(3, 11)),
            (Position(5, 1), Position(5, 2)), (Position(5, 3), Position(6, 3)),
            (Position(5, 4), Position(5, 3)), (Position(5, 4), Position(4, 4)), (Position(5, 6), Position(5, 7)), (Position(5, 8), Position(6, 8)), (Position(5, 10), Position(4, 10)),
            (Position(5, 12), Position(6, 12)), (Position(6, 0), Position(7, 0)),
            (Position(6, 2), Position(6, 3)), (Position(6, 3), Position(6, 4)), (Position(6, 5), Position(7, 5)), (Position(6, 7), Position(6, 8)), (Position(6, 9), Position(7, 9)),
            (Position(6, 10), Position(5, 10)), (Position(6, 11), Position(5, 11)),
            (Position(6, 12), Position(6, 11)), (Position(7, 2), Position(6, 2)), (Position(7, 6), Position(7, 7)), (Position(7, 6), Position(8, 6)), (Position(7, 9), Position(7, 10)),
            (Position(7, 11), Position(8, 11)),
            (Position(7, 12), Position(6, 12)),
            (Position(8, 2), Position(7, 2)), (Position(8, 2), Position(9, 2)), (Position(8, 4), Position(7, 4)), (Position(8, 6), Position(8, 5)), (Position(8, 7), Position(8, 8)),
            (Position(8, 9), Position(7, 9)), (Position(8, 12), Position(8, 11)),
            (Position(9, 0), Position(8, 0)), (Position(9, 1), Position(9, 0)), (Position(9, 2), Position(10, 2)), (Position(9, 3), Position(9, 4)), (Position(9, 5), Position(9, 6)),
            (Position(9, 6), Position(9, 7)), (Position(9, 8), Position(9, 7)),
            (Position(9, 9), Position(9, 8)), (Position(9, 10), Position(9, 9)), (Position(9, 11), Position(9, 10)), (Position(9, 12), Position(9, 11)), (Position(10, 1), Position(10, 0)),
            (Position(10, 3), Position(9, 3)),
            (Position(10, 4), Position(10, 5)), (Position(10, 5), Position(9, 5)), (Position(10, 7), Position(10, 6)), (Position(10, 9), Position(10, 8)), (Position(10, 9), Position(11, 9)),
            (Position(11, 1), Position(11, 0)),
            (Position(11, 2), Position(10, 2)), (Position(11, 3), Position(11, 2)), (Position(11, 9), Position(11, 8)), (Position(11, 9), Position(12, 9)), (Position(11, 12), Position(10, 12)),
            (Position(12, 1), Position(12, 0)),
