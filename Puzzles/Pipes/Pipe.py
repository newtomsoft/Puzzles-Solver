...
class Pipe:
    ...
    def get_connected_to(self) -> set[Direction]:
...
PIPE_SHAPE_STRING_TO_PIPE_STRING = {
    ' └─': "L0", '─┘ ': "L1", '─┐ ': "L2", ' ┌─': "L3",
    ' │ ': "I0", '───': "I1",
    '─┬─': "T0", ' ├─': "T1", '─┴─': "T2", '─┤ ': "T3",
    ' ╶─': "E0", ' ╵ ': "E1", '─╴ ': "E2", ' ╷ ': "E3",
}
PIPE_STRING_TO_PIPE_SHAPE_STRING = {v: k for k, v in PIPE_SHAPE_STRING_TO_PIPE_STRING.items()}

CONNECTIONS_TO_PIPE_STRING = {
