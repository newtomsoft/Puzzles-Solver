...
class GridPuzzleMoonsunGridProvider(IGridProvider, PlaywrightGridProvider, GridPuzzleGridCanvasProvider):
    ...
    def scrap_grid(self, browser: BrowserContext, url):
        ...
        return Grid(circle_matrix), RegionsGrid(open_matrix)
