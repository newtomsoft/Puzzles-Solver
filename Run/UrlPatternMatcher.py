...
import Run.Games.AyeheyaConfig
import Run.Games.BalanceLoopConfig
import Run.Games.BattleshipsConfig
...
import Run.Games.DeddoanguruConfig
...
import Run.Games.IrasutoConfig
import Run.Games.HitoriConfig
import Run.Games.IslandConfig
...
import Run.Games.KnossosConfig
...
import Run.Games.KurottoConfig
...
import Run.Games.MirukutiTeaseConfig
...
import Run.Games.RimotoejjiConfig
import Run.Games.RomaConfig
import Run.Games.RabbitsAndTreesConfig
import Run.Games.RoundTripConfig
import Run.Games.SashiganeConfig
...
import Run.Games.YakazuConfig
import Run.Games.SudokuConfig
import Run.Games.SutoretoConfig
...
class UrlPatternMatcher:
    ...
    def _initialize_registry(cls):
        ...
        Run.Games.AyeheyaConfig.register()
        Run.Games.ArofuroConfig.register()
        Run.Games.BalanceLoopConfig.register()
        Run.Games.BattleshipsConfig.register()
        ...
        Run.Games.DeddoanguruConfig.register()
        ...
        Run.Games.IrasutoConfig.register()
        Run.Games.HitoriConfig.register()
        Run.Games.IslandConfig.register()
        ...
        Run.Games.KnossosConfig.register()
        ...
        Run.Games.KurottoConfig.register()
        ...
        Run.Games.MirukutiTeaseConfig.register()
        ...
        Run.Games.RimotoejjiConfig.register()
        Run.Games.RomaConfig.register()
        Run.Games.RabbitsAndTreesConfig.register()
        Run.Games.RoundTripConfig.register()
        Run.Games.SashiganeConfig.register()
        ...
        Run.Games.YakazuConfig.register()
        Run.Games.SudokuConfig.register()
        Run.Games.SutoretoConfig.register()
