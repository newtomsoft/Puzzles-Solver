...
class FoseruzuSolverTests(TestCase):
    ...
    def test_6x6_easy_4wg94(self):
        """https://gridpuzzle.com/foseruzu/4wg94"""
        grid = Grid([
            [3, 2, 2, 3, 1, 3],
            [3, 3, 3, 3, 3, 3],
            [2, 1, 3, 2, 3, 1],
    ...
    def test_8x8_hard_0z7v8(self):
        """https://gridpuzzle.com/foseruzu/0z7v8"""
        grid = Grid([
            [3, _, 2, _, _, 2, _, 2],
            [2, 2, 3, 2, 2, 2, 2, 2],
            [_, 2, _, 2, 3, _, 2, _],
