...
class MoonsunSolver(GameSolver):
    ...
    def _init_island_grid(self):
        self._island_grid = IslandGrid([[Island(Position(r, c), 2) for c in range(self.circle_grid.columns_number)] for r in range(self.circle_grid.rows_number)])
