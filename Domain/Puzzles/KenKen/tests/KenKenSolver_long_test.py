...
class KenKenSolverLongTests(TestCase):
    ...
    def test_solution_9x9_hard(self):
        regions_operators_results = [
            ...
            ([Position(0, 5), Position(0, 6)], "-", 1),
            ([Position(0, 7), Position(0, 8)], "÷", 3),
            ([Position(1, 0), Position(2, 0)], "÷", 2),
            ([Position(1, 1), Position(1, 2)], "x", 24),
            ([Position(2, 4), Position(1, 4)], "+", 13),
            ([Position(2, 5), Position(1, 5)], "+", 13),
            ([Position(1, 6), Position(2, 6)], "÷", 2),
            ([Position(1, 7), Position(2, 7)], "-", 4),
            ([Position(3, 8), Position(1, 8), Position(2, 8)], "x", 80),
            ([Position(3, 1), Position(2, 1)], "-", 2),
            ([Position(3, 2), Position(2, 2)], "-", 6),
            ([Position(2, 3), Position(3, 3)], "+", 13),
            ([Position(4, 0), Position(3, 0)], "÷", 2),
            ([Position(3, 4), Position(3, 5)], "-", 5),
            ([Position(3, 7), Position(3, 6)], "-", 3),
            ([Position(4, 1), Position(4, 2), Position(4, 3)], "x", 80),
            ([Position(4, 4), Position(4, 5)], "÷", 2),
            ([Position(4, 6), Position(4, 7)], "+", 8),
            ([Position(4, 8), Position(5, 8)], "+", 13),
            ([Position(5, 0), Position(6, 0)], "+", 14),
            ([Position(5, 1), Position(5, 2)], "+", 10),
            ([Position(5, 3), Position(6, 2), Position(6, 3)], "x", 105),
            ([Position(5, 4), Position(6, 4)], "x", 12),
            ([Position(5, 5), Position(6, 5)], "÷", 2),
            ([Position(5, 6), Position(5, 7)], "-", 2),
            ([Position(6, 1), Position(7, 1)], "+", 13),
            ([Position(6, 6), Position(6, 7)], "÷", 4),
            ([Position(6, 8), Position(7, 8)], "x", 6),
            ([Position(7, 0), Position(8, 0)], "+", 9),
            ([Position(7, 2), Position(7, 3)], "x", 6),
            ([Position(7, 4), Position(7, 5)], "-", 1),
            ([Position(7, 6), Position(7, 7)], "-", 1),
            ([Position(8, 2), Position(8, 1)], "+", 13),
            ([Position(8, 3), Position(8, 4)], "x", 8),
            ([Position(8, 5), Position(8, 6)], "x", 18),
            ([Position(8, 7), Position(8, 8)], "-", 2),
        ]
        expected_solution = Grid(
            [
                [1, 8, 2, 6, 7, 5, 4, 9, 3],
