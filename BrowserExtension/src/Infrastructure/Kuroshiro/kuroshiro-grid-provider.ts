...
export class KuroshiroGridProvider {
    static getGridFromHTML(html: string): (string | null)[][] {
        ...
        for (let r = 0; r < size; r++) {
            ...
            for (let c = 0; c < size; c++) {
                ...
                if (val === '1') converted = KuroshiroCell.WHITE;
                else if (val === '2') converted = KuroshiroCell.BLACK;
                else if (val === 'W') converted = KuroshiroCell.WHITE;
                else if (val === 'B') converted = KuroshiroCell.BLACK;
                else if (val === '.') converted = KuroshiroCell.EMPTY;
                else converted = KuroshiroCell.EMPTY;
